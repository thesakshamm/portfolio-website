...
Machine Learning & AI: Scikit-Learn, XGBoost, LangChain, FAISS (Vector DB), RAG Architecture, Gemini API, Time-Series Forecasting, Feature Engineering
Data Science & Analysis: Pandas, NumPy, Matplotlib, Seaborn, Data Cleaning, Model Evaluation & Preprocessing
Tools & Frameworks: Streamlit, Git, GitHub, GitHub Actions, Joblib, Jupyter Notebook, VS Code
Databases & APIs: MySQL, SQLite, REST APIs, STAC API, Web Scraping, Query Optimization
...
[GitHub](https://github.com/thesakshamm/plant-health-predictor/) | [Live Demo](https://ndvi-predictor.streamlit.app/)
...
- Trained and evaluated an XGBoost Regressor on chronologically split time-series data to forecast plant vigor (NDVI) 14 days in advance using MAE and R² metrics
...
[GitHub](https://github.com/thesakshamm/nutrition-analyser) | [Live Demo](https://nutrition-analyser.streamlit.app/)
...
[GitHub](https://github.com/thesakshamm/Customer-Support-Agent) 
...
[GitHub](https://github.com/thesakshamm/f1-race-notifier-viber-bot)
...
[GitHub](https://github.com/thesakshamm/web-scraping-project)
...
## Summary
Computer Science undergraduate with proven experience building end-to-end machine learning models, RAG architecture, and automated data pipelines. Demonstrated track record in predictive forecasting (XGBoost, Scikit-Learn), geospatial and time-series feature engineering, and LLM integration using LangChain, Google Gemini API, and FAISS vector stores. Proficient in delivering interactive Streamlit dashboards and orchestrating automated API workflows with GitHub Actions and SQL databases. Seeking an AI/ML internship to apply expertise in predictive modeling and generative AI to scalable, real-world intelligent systems.